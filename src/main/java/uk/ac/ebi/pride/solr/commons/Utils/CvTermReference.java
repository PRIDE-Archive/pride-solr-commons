...
public enum CvTermReference {
    ...
    PRIDE_DECOY_HIT("PRIDE", "PRIDE:0000303", "Decoy hit", (String)null),
    PRIDE_GEL_BASED_EXPERIMENT("PRIDE", "PRIDE:0000305", "Gel-based experiment", (String)null),
    PRIDE_GEL_IDENTIFIER("PRIDE", "PRIDE:0000304", "Gel identifier", (String)null),
    PRIDE_GEL_SPOT_IDENTIFIER("PRIDE", "PRIDE:0000300", "Gel spot identifier", (String)null),
    PRIDE_INDISTINGUISHABLE_ACCESSION("PRIDE", "PRIDE:0000098", "Indistinguishable alternative protein accession", (String)null),
    PRIDE_PROTEIN_NAME("PRIDE", "PRIDE:0000063", "Protein description line", (String)null),
    PRIDE_REFERENCE_DOI("PRIDE", "PRIDE:0000042", "DOI", (String)null),
    PRIDE_REFERENCE_PUBMED("PRIDE", "PRIDE:0000029", "PubMed", (String)null),
    PRIDE_DOWNSTREAM_FLANKING_SEQUENCE("PRIDE", "PRIDE:0000066", "Downstream flanking sequence", (String)null),
    PRIDE_UPSTREAM_FLANKING_SEQUENCE("PRIDE", "PRIDE:0000065", "Upstream flanking sequence", (String)null),
    MS_CHARGE_STATE("MS", "MS:1000041", "charge state", (String)null),
    MS_PRECURSOR_MZ("MS", "MS:1000744", "selected ion m/z", (String)null),
    MS_DECOY_PEPTIDE("MS", "MS:1002217", "decoy peptide", (String)null),
    MS_MULTIPLE_SAMPLE("PRIDE", "PRIDE:0000366", "Contains multiple subsamples", (String)null),
    PRIDE_SAMPLE_DESCRIPTION("PRIDE", "PRIDE:0000017", "Sample description additional parameter", (String)null),
    MS_PSI_MZDATA_FILE("MS", "MS:1000564", "PSI mzData file", (String)null),
    MS_SPEC_NATIVE_ID_FORMAT("MS", "MS:1000777", "spectrum identifier nativeID format", (String)null),
    MS_FIXED_MOD("MS", "MS:1002453", "No fixed modifications searched", (String)null),
    MS_VAR_MOD("MS", "MS:1002454", "No variable modifications searched", (String)null),
    ...
    PRODUCT_ION_MZ_PLGS("Water", "PLGS:00024", "product ion m/z", (String)null),
    ...
    PRODUCT_ION_INTENSITY_PLGS("Water", "PLGS:00025", "product ion intensity", (String)null),
    ...
    PRODUCT_ION_MASS_ERROR_PLGS("Water", "PLGS:00026", "product ion mass error", (String)null),
    ...
    PRODUCT_ION_RETENTION_TIME_ERROR_PLGS("Water", "PLGS:00027", "product ion retention time error", (String)null),
    ...
    MS_SEARCH_ENGINE_SPECIFIC_SCORE("MS", "MS:1001153", "Search engine specific score", (String)null),
    ...
    MS_PUBLICATION_PUBMED_IDENTIFIER("MS", "MS:1000879", "PubMed identifier", (String)null),
    MS_PUBLICATION_REFERENCE("MS", "MS:1002866", "Reference", (String)null),
    ...
    public Collection<String> getChildAccessions() {
        ...
        CvTermReference[] cvTerms = values();
        CvTermReference[] var3 = cvTerms;
        int var4 = cvTerms.length;

        for(int var5 = 0; var5 < var4; ++var5) {
            CvTermReference cv = var3[var5];
            if (cv.getParentAccessions().contains(this.accession)) {
